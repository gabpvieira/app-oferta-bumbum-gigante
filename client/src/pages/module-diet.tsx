      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="bg-gradient-to-r from-orange-500 to-red-500 text-white">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              <Utensils className="w-8 h-8 mr-3 text-orange-100" />
              <div>
                <h2 className="text-2xl font-bold text-white">Mini-Dieta Bônus</h2>
                <p className="text-orange-100">Receitas e Dicas Que Potencializam Seus Resultados</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 text-center border border-white/30">
                <Apple className="w-6 h-6 mx-auto mb-2 text-orange-100" />
                <p className="text-sm font-medium text-white">30 Receitas</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 text-center border border-white/30">
                <Heart className="w-6 h-6 mx-auto mb-2 text-orange-100" />
                <p className="text-sm font-medium text-white">Simples</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 text-center border border-white/30">
                <Target className="w-6 h-6 mx-auto mb-2 text-orange-100" />
                <p className="text-sm font-medium text-white">Focadas</p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3 text-center border border-white/30">
                <Star className="w-6 h-6 mx-auto mb-2 text-orange-100" />
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                {principles.map((principle, index) => (
                  <Card key={index} className="border-l-4 border-l-orange-500 border-orange-200 shadow-md hover:shadow-lg transition-shadow">
                    <CardContent className="p-4">
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-4">
                {mealSchedule.map((meal, index) => (
                  <div key={index} className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-lg p-4 shadow-sm">
                    <div className="grid md:grid-cols-3 gap-4">
                      <div>
                        <h4 className="font-semibold text-orange-700">{meal.time}</h4>
                      </div>
                      <div>
                        <p className="text-gray-600 text-sm">{meal.objective}</p>
                      </div>
                      <div>
                        <p className="font-medium text-gray-800 text-sm">{meal.foods}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {breakfastRecipes.map((recipe, index) => (
                  <Card key={index} className="border-orange-200 shadow-md hover:shadow-lg transition-shadow">
                    <CardContent className="p-4">
                      <h4 className="font-semibold text-orange-700 mb-2">{index + 1}. {recipe.name}</h4>
                      <div className="space-y-2">
                        <div>
                          <p className="text-sm font-medium text-orange-600">Ingredientes:</p>
                          <p className="text-sm text-gray-700">{recipe.ingredients}</p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-orange-600">Modo:</p>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {lunchDinnerRecipes.map((recipe, index) => (
                  <Card key={index} className="border-orange-200 shadow-md hover:shadow-lg transition-shadow">
                    <CardContent className="p-4">
                      <h4 className="font-semibold text-orange-700 mb-2">{index + 11}. {recipe.name}</h4>
                      <div className="space-y-2">
                        <div>
                          <p className="text-sm font-medium text-orange-600">Ingredientes:</p>
                          <p className="text-sm text-gray-700">{recipe.ingredients}</p>
            ...
            <CardContent className="p-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {snackRecipes.map((recipe, index) => (
                  <Card key={index} className="border-orange-200 shadow-md hover:shadow-lg transition-shadow">
                    <CardContent className="p-4">
                      <h4 className="font-semibold text-orange-700 mb-2">{index + 21}. {recipe.name}</h4>
                      <div className="space-y-2">
                        <div>
                          <p className="text-sm font-medium text-orange-600">Ingredientes:</p>
                          <p className="text-sm text-gray-700">{recipe.ingredients}</p>
                  ...
                  <Card key={index} className="border-l-4 border-l-orange-500 border-orange-200 shadow-md hover:shadow-lg transition-shadow">
                    <CardContent className="p-4">
                      <h4 className="font-semibold text-gray-800 mb-2 flex items-center">
                        <span className="w-6 h-6 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white text-xs mr-3">
                          {index + 1}
                        </span>
                        {tip.title}
                      </h4>
        ...
        <Card className="bg-gradient-to-r from-orange-50 to-red-50 border-orange-200 shadow-lg">
          <CardContent className="p-6 text-center">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg p-4 inline-block shadow-md">
